            ...
            <div class="container-xxl">
                ...
                <div class="d-flex justify-content-center h-52px">
                    ...
                    <RouterLink to="/access"
                        class="d-none d-md-flex align-items-center me-3 link-dark text-decoration-none">交通アクセス</RouterLink>
                    <!-- ボタンスタイル(アウトラインあり) / location.hrefでページ遷移、スマホ表示のときのみ改行 -->
                    <RouterLink to="/document">
                        <button class="btn btn-dark h-100 d-flex align-items-center" role="button">資料<br class="d-sm-none">請求</button>
                    </RouterLink>
                </div>
            </div>
        </nav>
